...
export default function RegisterPage() {
    ...
    const submit = async (e) => {
        ...
        try {
            await register({ email, password, fullName: fullName || null });
            setSuccess(true);
            nav("/login");
        } catch (err) {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-6">
                ...
                <p className="mt-1 text-sm text-slate-600">Создайте аккаунт.</p>
                ...
                <form className="mt-5 space-y-3" onSubmit={submit}>
                    ...
                    <Field label="Имя (опционально)" value={fullName} onChange={setFullName} placeholder="Иван Иванов" />
